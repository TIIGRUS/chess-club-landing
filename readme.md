...
- [x] Чистый стек: HTML + CSS + JS без библиотек и фреймворков
- [x] Pixel Perfect — соответствие макету Figma
- [x] Адаптивная вёрстка — нет горизонтального скролла, текст не выходит за границы и не наезжает на другой текст или изображение
- [x] Нет дублирования текстового контента для мобильной и десктопной версий
